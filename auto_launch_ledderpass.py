...
def main():
    ...
    # 22
    name_terminal("LOCAL_AVOIDANCE")
    type_cmd("LOCAL_AVOIDANCE")
    move_focus("next")  
    time.sleep(3)
    ...
    # 24
    name_terminal("rostopic list")
    type_cmd("rostopic list")
    move_focus("next")   
    ...
    time.sleep(2)
    type_cmd("rosparam load 230327_ledder_pass.yaml")
    time.sleep(2)
    move_focus("next") 

    # 33
    name_terminal("setpoint local")
    type_cmd("rostopic echo /mavros/setpoint_raw/local -c")
    move_focus("next")
    ...
    # 42
    name_terminal("param /Alt_desired")
    type_cmd("rosparam set /ledder/Alt_desired")
    move_focus("next")
