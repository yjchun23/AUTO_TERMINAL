...
def main():
    ...
    split_terminator_SILS() # predefined 3*4 layout

    name_terminal("SILS_OPEN")
    # type_cmd("cd")    
    type_cmd("compet")
    type_cmd("SILS")
    time.sleep(5)
    ...
    # 12
    name_terminal("LEDDER_PASS")
    type_cmd("LEDDER_PASS")
    move_focus("next")
    ...
    # 14
    name_terminal("LOCAL_AVOID")
    type_cmd("LOCAL_AVOID")
    move_focus("next")

    # 21
    name_terminal("FSM_MANUAL")
    type_cmd("FSM_MANUAL")
    move_focus("next")

    # 22
    name_terminal("TARGET_LOCAL")
    type_cmd("TARGET_LOCAL")
    move_focus("next")   

    # 23
    name_terminal("LANDING_LOCAL")
    type_cmd("LANDING_LOCAL")
    move_focus("next")   
    ...
    # 33
    name_terminal("LANDING_CONTROL")
    type_cmd("LANDING_CONTROL")
    move_focus("next")
